      ...
      <div  class="container">
        ...
        <div   class=" collapse navbar-collapse justify-content-end" id="navbarSupportedContent" data-toggle="collapse" data-target=".navbar-collapse">
          <ul  class="navbar-nav  mb-2 mb-lg-0">
            ...
            <li class="nav-item nav-item-sm">
              <a class="nav-link nav-item-sm" href="#faq" >Faq</a>
            </li>  
            <li class="nav-item">
              <a class="nav-link nav-item-sm" href="#projects" >Portfolio</a>
            </li>  
            <li class="nav-item">
              <a class="nav-link nav-item-sm" href="#getstarted" >Contact</a>
            </li>  
            
           
          </ul>
          <button type="button" class="rounded-pill btn-rounded"> +92 332 2411 710  <span ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill mysvg" viewBox="0 0 16 16">
